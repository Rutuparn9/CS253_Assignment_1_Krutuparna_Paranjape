...
class Car{
    ...
    void modify_car_details(string serial_number_no);
};
...
void Customer :: show_customer_dropdown_menu(string id){
    ...
    if(c=='1'){
        ...
        cout << "Rental Fee : Rs 1000 per day\n";
...
void Employee :: show_employee_dropdown_menu(string id){
    ...
    if(c=='1'){
        ...
        cout << " Rental fee : Rs 850 per day\n";
        ...
        if(count<rec){
            ...
            for(int i=0;i<items.size();i++){
                if(items[i][0]==Model_name && items[i][4]=="0"){
                    ...
                    cout << "\n";
                    cout << "Fine : Rs 500 will be imposed everyday after the due date\n";
                    items[i][4]="1";
                    new_string.clear();
...
void Car :: modify_car_details(string id){
    Manager l;
    l.modify_cars(id);
}
